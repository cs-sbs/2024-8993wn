...
public class adm_help extends JFrame{
	...
	JLabel lbarray[]={new JLabel("欢迎进入后台管理系统"),new JLabel("添加图书功能"),
			new JLabel("删除图书功能"),new JLabel("注册新管理员"),new JLabel("删除管理员"),
	...
	JTextArea jtarray[]={new JTextArea("    后台管理部分是由管理员管理，可以对图书\n进行\"增删改查\"，" +
			...
			new JTextArea("    删除图书功能，是一个通用类功能，根据右\n侧显示的表格，查找到需要进行删除操作书籍\n的编号，进行删除操作。"
					+ ""),new JTextArea("    填写必要信息，注册新管理员，注意保管好\n密码。"),
					new JTextArea("    删除管理员和所有删除操作一样，使用通用\n的类，进行删除。"),
					new JTextArea("    同上"),
